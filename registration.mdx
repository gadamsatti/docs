...
1. **Visit the Business Creation Portal**  
   ...
   <Frame>
     <img src="/path/image1.1.png" alt="image1.1.png" />
   </Frame>
...
<Note>
  Make sure you have your business details ready before starting the registration process.
</Note>
...
<Frame>
  <img src="/path/image1.2.png" alt="Registration Portal" />
</Frame>
...
1. **Access Registration Form** 💼
   ...
   <Frame>
     <img src="/path/image1.3.png" alt="Registration Form" />
   </Frame>
...
2. **Fill in Your Details** ✏️
   ...
   - Ensure there are no typos, as these details will be used for verification

   <Warning>
     Double-check your email address - this will be used for account verification and recovery.
   </Warning>
...
<Tip>
  Keep your login credentials in a secure place - you'll need them to access your business dashboard.
</Tip>
...
<Note>
  For technical issues during registration, please contact our support team with the error message and a screenshot if possible.
</Note> 