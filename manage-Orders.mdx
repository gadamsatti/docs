...
## Overview
The Manage Orders page offers a comprehensive view of all customer orders in a responsive table format. Monitor order statuses, track deliveries, and manage customer transactions all in one place.
<Frame>
...
<ParamField body="total_items" type="number">
  Number of items in the order
</ParamField>
<ParamField body="order_type" type="enum">
  - Offline
  - Online
</ParamField>
